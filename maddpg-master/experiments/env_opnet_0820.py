...
class Env_team():
    def __init__(self):
        ...
        self.lowlist1 = [0, 0, 0, 2000, 40000]
        self.highlist1 = [5000, 8000, 10000, 90000, 100000]
    ...
    def get_time_date(self):
        ...
        self.state_all[36] = [self.city_Wuhan[6], self.city_Wuhan[4], self.city_Wuhan[1], self.city_Wuhan[3], self.city_Wuhan[3]]
        self.state_all[37] = [self.city_Wuhan[7], self.city_Wuhan[4], self.city_Wuhan[1], self.city_Wuhan[3], self.city_Wuhan[3]]
        self.state_all[38] = [self.city_Wuhan[8], self.city_Wuhan[5], self.city_Wuhan[1], self.city_Wuhan[3], self.city_Wuhan[3]]
        self.state_all[39] = [self.city_Wuhan[9], self.city_Wuhan[5], self.city_Wuhan[1], self.city_Wuhan[3], self.city_Wuhan[3]]
    ...
    def fram_step(self, action):
        ...
        return state_new,reward,done,"ssss"
